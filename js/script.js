...
// Machine learning Circular bar 
let mlProgress = document.querySelector(".machine-learning"),
...
let progressML = setInterval(() => {
  ...
  mlProgress.style.background = `conic-gradient(#ff9800 ${mlStartValue * 3.6}deg, #ededed 0deg)`; 
